                ...
                <nav class="navbar navbar-default">
                 <div class="container-fluid">
                    ...
                    <ul class="nav nav-tabs">              
                        <li role="presentation"><a href="index.php"> Chamados Disponiveis</a></li>
                        <li role="presentation" class="active"><a href="#">Chamados em Andamento</a></li>
                    ...
                    if ($res->num_rows > 0) {//verifiaca se possui funcionarios
                        ...
                        <h1>
                            <div class="alert alert-info">
                                <strong>Info!</strong> Não há Chamados em Andamento
                            </div>
                        </h1>
                        <?php
                    }
